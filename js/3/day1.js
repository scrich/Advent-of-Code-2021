...
for (let index = 1; index < input.length; index++) {
    let prev = parseInt(input[index-1]);
    let t = parseInt(input[index]);
  
    // let prev = (input[index-1]);
    // let t = (input[index]);
    // console.log(index, prev,t, "count is "+count);
    if (t>prev) {
        count++;
    ...
    // console.log(index+1, prev,t, t>prev, "count is "+count);
}

console.log(count);


// now try if it's just text, not int
for (let index = 1; index < input.length; index++) {
    // let prev = parseInt(input[index-1]);
    // let t = parseInt(input[index]);
    ...
    if (t>prev) {
        textcount++;
        textresults.push("increased");
    } else {
        textresults.push("decreased");
    }
    // console.log(index+1, prev,t, t>prev, "count is "+count);
}
...
for (let index = 0; index < results.length; index++) {
    if (results[index] != textresults[index])
    {console.log( index, results[index], textresults[index]);
    }
}
